...
export default function AddStudent({addStudent}) {
  ...
  return (
    <>
            ...
            {/* <h1 className="text-center">Edit a student</h1> */}
            ...
            {/* <button onClick={()=>updateDetails({firstname,lastname,email,password})} className="btn btn-success w-100">Update Details</button> */}
